...
| admin-bypass         | Toggle admin bypass on branch protection before/after release. Disable for repos without branch protection or on free GitHub plans. Default is 'true'. Set to 'false' to skip. | Optional (default `"true"`)                                 |
